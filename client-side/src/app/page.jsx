    ...
    return (
        <>
            ...
            <section className="mb-8">
                ...
                <div className="grid grid-cols-[repeat(1,270px)]  sm:grid-cols-[repeat(2,270px)] md:grid-cols-[repeat(3,270px)] lg:grid-cols-[repeat(4,270px)] gap-8 lg:gap-10 justify-center sm:justify-between w-full">
                    {/* Ex Item */}
                    <div className="relative w-[270px]">
                        ...
                        <h4 className="mb-1.5 font-semibold whitespace-nowrap overflow-hidden text-ellipsis w-[270px]">
                            Breed Dry Dog Food
                        </h4>
